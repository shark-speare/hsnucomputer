...
class Chat(commands.Cog):
    ...
    async def on_message(self, msg:discord.Message):
        if msg.channel.id != 1344529522019532951 or msg.author.bot: return
        ...
        prompt = f"這些是一串聊天記錄組成的清單。每一項有一個元組，是一則訊息，包含了發言者名稱與內容，請你扮演「要不要管電機」這個角色來聊天，請說出下一句話，不需要包含角色身份等等，只要說話的內容就好: {msgs}"
